    ...
    <div class="min-h-screen bg-gray-50 pb-10">
        ...
        <div class="bg-white shadow-lg sm:rounded-lg mb-8 p-6 border-t-4" :class="isEditing ? 'border-yellow-500' : 'border-indigo-600'">
            ...
            <div class="sm:col-span-2">
                ...
                <select v-model="form.priority" class="block w-full rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-600 sm:text-sm px-3">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center mb-4 gap-4">
            <div class="flex gap-2 flex-wrap">
                ...
                <button @click="filterStatus = 'en_progreso'" :class="filterStatus === 'en_progreso' ? 'bg-blue-100 text-blue-800 border-blue-200' : 'bg-white text-gray-700'" class="px-4 py-2 rounded-full text-sm font-medium shadow-sm border hover:bg-gray-50 transition">En Progreso</button>
            ...
            <p class="text-sm text-gray-500">Mostrando {{ filteredTasks.length }} tareas</p>
        </div>
...
// Helper para mostrar el nombre bonito de la prioridad
...
const loadTaskForEdit = (task) => {
    form.value = { 
        ...
        status: task.status,
        priority: task.priority || 'medium' // Cargar prioridad existente o default
    };
